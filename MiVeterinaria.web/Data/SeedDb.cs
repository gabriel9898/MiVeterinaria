...
using MiVeterinaria.web.Helpers;
using System;
using System.Linq;
...
namespace MiVeterinaria.Web.Data
{
    public class SeedDb
    {
        ...
        public SeedDb(
            DataContext context,
            IUserHelper userHelper)// busca en los inyectores y crea una nueva 
        {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Juan", "Zuluaga", "admin@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("2020", "Juan", "Zuluaga", "customer@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", "Customer");
